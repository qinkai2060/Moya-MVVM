...
@class WARFriendCommentCell,WARMomentVoice,WARFriendCommentVoiceView;
@protocol WARFriendCommentCellDelegate <NSObject>
...
@interface WARFriendCommentCell : UITableViewCell

+ (instancetype)cellWithTableView:(UITableView *)tableView;

/** delegate */
@property (nonatomic, weak) id<WARFriendCommentCellDelegate> delegate;
