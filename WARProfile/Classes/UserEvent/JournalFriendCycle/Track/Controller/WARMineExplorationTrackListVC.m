...
@interface WARMineExplorationTrackListVC ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,WARMineExplorationBaseCellDelegate>
...
@implementation WARMineExplorationTrackListVC
...
#pragma mark - WARMineExplorationBaseCellDelegate
...
-(void)mineExpBaseCell:(WARMineExplorationBaseCell *)mineExpBaseCell didImageIndex:(NSInteger) index imageComponents:(NSArray <WARFeedImageComponent *>*) imageComponents magicImageView:(UIView *)magicImageView {
    WARMoment *moment = mineExpBaseCell.moment;
...
-(void)mineExpBaseCell:(WARMineExplorationBaseCell *)mineExpBaseCell actionType:(WARMineExpCellActionType)actionType value:(id)value {
    switch (actionType) {
        case WARMineExpCellActionTypeDidPageContent:
        {
        ...
        case WARMineExpCellActionTypeScrollHorizontalPage:{
        ...
        case WARMineExpCellActionTypeFinishScrollHorizontalPage:{
