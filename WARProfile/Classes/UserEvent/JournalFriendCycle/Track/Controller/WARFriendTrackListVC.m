...
@interface WARFriendTrackListVC ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,WARFriendBaseCellDelegate,UIMessageInputViewDelegate>
...
@implementation WARFriendTrackListVC
