...
NSString * const WARMomentCircleProgressViewAnimationKey = @"WARMomentCircleProgressViewAnimationKey";
...
@interface WARMomentCircleProgressView () <UIGestureRecognizerDelegate>

@property (nonatomic, strong) UACircularProgressView *progressView;
@property (nonatomic, strong) UACircularProgressView *grayProgressView;
...
@implementation WARMomentCircleProgressView
...
- (void)sharedSetup {
    self.grayProgressView = [[UACircularProgressView alloc] initWithFrame:self.bounds];
    self.grayProgressView.shapeLayer.fillColor = [UIColor clearColor].CGColor;
    [self addSubview:self.grayProgressView];
...
- (void)setBorderWidth:(CGFloat)borderWidth {
    ...
    self.grayProgressView.shapeLayer.borderWidth = borderWidth;
    self.progressView.shapeLayer.borderWidth = 0.0;
}

- (void)setBorderColor:(UIColor *)borderColor {
    _borderColor = borderColor;
    self.grayProgressView.shapeLayer.borderColor = borderColor.CGColor;
    self.progressView.shapeLayer.borderColor = [UIColor clearColor].CGColor;
}

- (void)setLineWidth:(CGFloat)lineWidth {
    _lineWidth = lineWidth;
    self.grayProgressView.shapeLayer.lineWidth = 0.0;
...
- (void)layoutSubviews {
    ...
    self.grayProgressView.frame = self.bounds;
...
- (void)animateToProgress:(CGFloat)progress {
    ...
    [self.progressView.layer addAnimation:animation forKey:WARMomentCircleProgressViewAnimationKey];
...
- (void)stopAnimation {
    ...
    [self.progressView.layer removeAnimationForKey:WARMomentCircleProgressViewAnimationKey];
