...
@implementation WARFeedHotelCell

#pragma mark - System

+ (instancetype)cellWithTableView:(UITableView *)tableView {
    WARFeedHotelCell* cell = [tableView dequeueReusableCellWithIdentifier:@"WARFeedHotelCell"];
    if (!cell) {
        cell = [[[WARFeedHotelCell class] alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"WARFeedHotelCell"];
    }
    return cell;
}
...
//    [self.iconView sd_setImageWithURL:store.mainImageId placeholderImage:[WARUIHelper war_defaultUserIcon]];
        [self.iconView sd_setImageWithURL:kOriginMediaUrl(store.mainImageId) placeholderImage:[WARUIHelper war_defaultUserIcon]];
