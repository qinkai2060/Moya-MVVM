...
@end
@implementation WARPhotoListLayout
#pragma mark- 构造方法
- (instancetype)init {
    if (self = [super init]) {
        self.columnCount = 2;
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //根据最短列的列数计算item的x值
    CGFloat itemX = self.sectionInset.left + (5 + itemWidth) * minIndex.integerValue;
