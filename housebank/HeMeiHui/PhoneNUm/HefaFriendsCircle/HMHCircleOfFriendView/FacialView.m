...
-(void)loadFacialView:(int)page size:(CGSize)size
{
    ...
    [sendButton setBackgroundImage:[UIImage imageNamed:@"chatFaceSend"] forState:UIControlStateNormal];
     [sendButton setBackgroundImage:[UIImage imageNamed:@"chatFaceSend"] forState:UIControlStateHighlighted];
