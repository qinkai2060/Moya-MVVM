...
/** 视频拉伸方式 */
typedef NS_ENUM(NSUInteger, TracyVideoGravity){
...
/** 全屏状态下状态栏显示方式 */
typedef NS_ENUM(NSInteger, TracyStatusBarHideState)
{
...
@interface TracyPlayerConfiguration : NSObject
...
/** 视频拉伸方式 */
@property (nonatomic, assign) TracyVideoGravity videoGravity;
/** 是否重复播放 */
