...
#import "TracyVideoSlider.h"
#import "TracyPlayerConfiguration.h"

/** 播放器控制面板代理 */
@protocol TracyPlaybackControlsDelegate <NSObject>
...
@interface TracyPlaybackControls : UIView
...
/** 进度滑杆 */
@property (nonatomic, strong) TracyVideoSlider *videoSlider;
/** 播放时间 */
...
/** 播放器控制面板代理 */
@property (nonatomic, weak) id<TracyPlaybackControlsDelegate> delegate;
/** 隐藏控制面板延时时间 缺省5s */
@property (nonatomic, assign) NSTimeInterval hideInterval;
/** 是否处于全屏状态 */
@property (nonatomic, assign) BOOL isFullScreen;
/** 全屏状态下状态栏显示方式 */
@property (nonatomic, assign) TracyStatusBarHideState statusBarHideState;
/** 加载指示器 */
