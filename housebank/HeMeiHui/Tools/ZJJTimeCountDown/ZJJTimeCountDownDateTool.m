...
/**
 ...
 @return 时间字符串
 */
+ (NSString *)dateByAddingSeconds:(NSString*)seconds timeStyle:(ZJJCountDownTimeStyle)timeStyle{

    NSTimeInterval aTimeInterval = [NSDate timeIntervalSinceReferenceDate] + [seconds integerValue];
