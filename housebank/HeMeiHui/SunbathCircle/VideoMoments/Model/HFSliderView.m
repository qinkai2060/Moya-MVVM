...
- (void)setValue:(float)value {
    ...
    if (self.sliderBtn.hidden) {
        ...
        self.sliderProgressView.width = self.sliderBtn.centerY;
    }
}
...
- (void)startAnimating {
    ...
    scaleAnimation.toValue = @(self.width * 10);
...
- (void)sliderBtnDragMoving:(UIButton *)btn point:(CGPoint)touchPoint {
    ...
    CGFloat value = (point.x - btn.width * 0.5) / self.bgProgressView.width;
    // value的值需在0-1之间
