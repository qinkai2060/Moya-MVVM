...
- (void)layoutSubviews{
    ...
    if (self.nickNameLabel.hidden) {
        ...
        self.accountLabel.bottom  = 100 - AccountBottom;
    }else{
        self.nickNameLabel.left    = self.nameLabel.left;
        self.nickNameLabel.bottom  = 100 - AccountBottom;
        self.accountLabel.left     = self.nameLabel.left;
        self.accountLabel.centerY  = (self.nickNameLabel.top + self.nameLabel.bottom) * 0.5f;
    }
