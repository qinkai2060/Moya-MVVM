...
typedef NS_ENUM(NSInteger, UIGestureRecognizerType) {
    UIGestureRecognizerTypeClick,//默认从0开始
    UIGestureRecognizerTypeLongPress,
};


@interface UIView (NTES)

-(void)setClickListener:(id)target action:(SEL)action forEvent: (UIGestureRecognizerType) type;
