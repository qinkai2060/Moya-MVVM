...
//    NTESBirthPickerView *picker = [[NTESBirthPickerView alloc] initWithFrame:self.view.bounds];
    NTESBirthPickerView *picker = [[NTESBirthPickerView alloc] initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height - 250, [UIScreen mainScreen].bounds.size.width, 250)];
