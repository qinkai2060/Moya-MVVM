...
//#import "NTESJanKenPonAttachment.h"  // 石头剪子布
//#import "NTESFileTransSelectViewController.h" // 文件传输
//#import "NTESAudioChatViewController.h"  // 实时语音
...
//#import "NTESSessionLocalHistoryViewController.h"  // 获取聊天本地消息
...
- (void)sendSnapchatMessagePath:(NSString *)path // 阅后即焚
{
...
#pragma mark - Cell事件
#pragma mark 点击语音 图片 地图等 cell上的点击事件
...
- (void)enterTeamCard:(id)sender{ // 讨论组
//    NIMTeam *team = [[NIMSDK sharedSDK].teamManager teamById:self.session.sessionId];
//    UIViewController *vc;
