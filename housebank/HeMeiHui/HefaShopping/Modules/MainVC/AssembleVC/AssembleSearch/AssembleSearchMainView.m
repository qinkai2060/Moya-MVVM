...
@interface AssembleSearchMainView ()<UITableViewDelegate,UITableViewDataSource,searchFooterViewDelegate>
...
@implementation AssembleSearchMainView
...
-(void)createView{
    ...
    //
    self.searchView = [[AssembleSearchView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, 44) isAddOneBtn:YES addBtnImageName:@"" addBtnTitle:@"取消" searchKeyStr:@"" canEidt:YES placeholderStr:@"" isHaveBack:NO isHaveBottomLine:YES];
