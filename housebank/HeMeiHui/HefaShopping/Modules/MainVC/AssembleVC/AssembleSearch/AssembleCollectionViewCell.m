...
@interface AssembleCollectionViewCell ()
...
@end
@implementation AssembleCollectionViewCell
...
- (void)createView{
    ...
    self.lineLable=[[UILabel alloc]initWithFrame:CGRectMake(15, self.contentView.height-1, ScreenW-30, 1)];
...
- (void)refreshCellWithModel:(id)model{
    ...
    NSString *str2=[NSString stringWithFormat:@"¥%ld",(long)dataItem.naturalPrice];
