...
//    HFZuberViewModel *viewmodel = (HFZuberViewModel*)self.viewmodel;
        [self.imageView sd_setImageWithURL:[NSURL URLWithString:self.zuberModel.imgUrl] placeholderImage:[UIImage imageNamed:@"SpTypes_default_image"]];
