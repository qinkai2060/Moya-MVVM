...
@end
@implementation HFGCDManger
+ (HFGCDManger *)sharedInstance {
    static HFGCDManger *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[HFGCDManger alloc] init];
    });
