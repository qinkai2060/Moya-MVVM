...
//    NSLog(@"正在");
    if ([self.delegate respondsToSelector:@selector(slidMovedView:andRightState:)]) {
        [self.delegate slidMovedView:self andRightState:JLSliderStateIng];
    }
    if(self.isCoincide){
...
-(void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    NSLog(@"开始");
    if ([self.delegate respondsToSelector:@selector(slidMovedView:andRightState:)]) {
        [self.delegate slidMovedView:self andRightState:JLSliderStateBegin];
    }
    UITouch *touch  = [touches anyObject];
    CGPoint  point  = [touch locationInView:self];
    self.startX = point.x;
...
-(void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    NSLog(@"结束了");
    if ([self.delegate respondsToSelector:@selector(slidMovedView:andRightState:)]) {
        [self.delegate slidMovedView:self andRightState:JLSliderStateEnd];
    }
