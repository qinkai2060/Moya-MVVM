...
@interface HFFamousGoodsViewController ()
...
@implementation HFFamousGoodsViewController
...
- (void)viewDidLoad {
    ...
    [SVProgressHUD show];
    NSString * utrl = [[NetWorkManager shareManager] getForKey:@"mall./m/activity/famous-discount/list"];
    self.viewModel.requstURL = utrl;
    self.viewModel.requstPrams = @"Banner_famous";
...
- (void)setNav {
    ...
    titleView.image = [UIImage imageNamed:@"famous_title"];
...
- (void)fowardClick {
    self.viewModel.pageTag = @"fy_mall_outlets";
